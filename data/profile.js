  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        { date: "2021", title: { zh: "長期照護專業人員研習（16 小時）", en: "Long-term Care Professional Training (16 hours)" }, organization: { zh: "馬偕醫學院長期照護研究所", en: "Graduate Institute of Long-term Care, Mackay Medical College" }, type: { zh: "研習證書", en: "Training certificate" }, evidence: [{ label: { zh: "研習證明", en: "Training certificate" }, url: "https://drive.google.com/file/d/1gkM4AAfqHhMoKUA_0H3kozBzDGMmXZZA/view" }] },
    ...
    },
    {
      ...
      items: [
        ...
        { date: "2020–2021", title: { zh: "以社會支持架構建置育齡乳癌女性生育保存決策之行動工具", en: "A social-support-based mobile tool for oncofertility decision support among reproductive-age women with breast cancer" }, organization: { zh: "科技部研究計畫；計畫主持人：黃升苗教授", en: "MOST project; Principal Investigator: Prof. Sheng-Miauh Huang" }, type: { zh: "研究參與", en: "Research collaboration" }, missingEvidence: true }
      ]
    },
    {
      id: "conferences", title: { zh: "研討會發表", en: "Conference Presentations" },
      items: [
        { date: "2026/10/21–23", title: { zh: "Transforming Obesogenic Environments: Integrating Fitness, Nutrition and Systems Epidemiology", en: "Transforming Obesogenic Environments: Integrating Fitness, Nutrition and Systems Epidemiology" }, organization: { zh: "APACPH Conference，台南", en: "APACPH Conference, Tainan, Taiwan" }, type: { zh: "受邀講者", en: "Invited Speaker" }, evidence: [{ label: { zh: "邀請函", en: "Invitation letter" }, url: "https://drive.google.com/file/d/1lQ63ADnzOr0CwxFpXutAzSe7LdhAawtg/view" }] },
        { date: "2025", title: { zh: "11th Asian Conference on Aging & Gerontology", en: "11th Asian Conference on Aging & Gerontology" }, organization: { zh: "日本東京", en: "Tokyo, Japan" }, type: { zh: "壁報發表", en: "Poster" }, evidence: [{ label: { zh: "海報 PDF", en: "Poster PDF" }, url: "https://drive.google.com/file/d/1IJNuBmeYl2xRe1iIikp_2ZbxEo9MeCW9/view" }] },
        { date: "2023", title: { zh: "Conference on Gerontechnology", en: "Conference on Gerontechnology" }, organization: { zh: "台北", en: "Taipei, Taiwan" }, type: { zh: "口頭發表", en: "Oral presentation" }, evidence: [{ label: { zh: "發表資料 PDF", en: "Presentation record PDF" }, url: "https://drive.google.com/file/d/1cBg_vorspzV2vC231Kwi_BX7hC1M3TQL/view" }, { label: { zh: "發表簡報 PPTX", en: "Presentation PPTX" }, url: "https://drive.google.com/file/d/1L8btPPHeaGwGkga7S4CaN1oRVRz53AYd/view" }] },
        { date: "2022", title: { zh: "高齡福祉科技研討會", en: "Conference on Gerontechnology and Welfare Technology" }, organization: { zh: "台北", en: "Taipei, Taiwan" }, type: { zh: "口頭發表", en: "Oral presentation" }, evidence: [{ label: { zh: "研習證明", en: "Attendance certificate" }, url: "https://drive.google.com/file/d/1OrCOYbe4QSw51Dsuy_l9jiv6MH9U2im5/view" }] },
        { date: "2022", title: { zh: "ISG 2022", en: "ISG 2022" }, organization: { zh: "韓國大邱", en: "Daegu, Republic of Korea" }, type: { zh: "口頭發表", en: "Oral presentation" }, evidence: [{ label: { zh: "ISG 發表簡報", en: "ISG presentation" }, url: "https://drive.google.com/file/d/1kt9Nqm5DsRM9UlEomRpJweqhrtjXFB7o/view" }] }
      ]
    },
    {
      id: "awards", title: { zh: "獎項", en: "Awards" },
      items: [
        { date: "2021", title: { zh: "高齡福祉科技研討會論文發表佳作獎", en: "Merit Award, Conference Paper Presentation" }, organization: { zh: "高齡福祉科技研討會", en: "Conference on Gerontechnology and Welfare Technology" }, type: { zh: "獎項", en: "Award" }, evidence: [{ label: { zh: "獲獎紀錄 PDF", en: "Award record PDF" }, url: "https://drive.google.com/file/d/1Q5Rx4C5-mtH1DPuKF2Mz4FlLi9HH7T1U/view" }] },
        { date: "2021", title: { zh: "研究生壁報競賽佳作獎", en: "Merit Award, Graduate Student Poster Competition" }, organization: { zh: "馬偕醫學院", en: "Mackay Medical College" }, type: { zh: "獎項", en: "Award" }, evidence: [{ label: { zh: "獲獎紀錄 PDF", en: "Award record PDF" }, url: "https://drive.google.com/file/d/1NSc52fz9Y_uQrH58iHDjcFt98myxrrkl/view" }] },
        { date: "2021", title: { zh: "圖書館整合查詢館際三冠王活動第三名", en: "Third Place, Library Integrated Discovery Challenge" }, organization: { zh: "馬偕醫學院圖書館", en: "Mackay Medical College Library" }, type: { zh: "獎項", en: "Award" }, evidence: [{ label: { zh: "獎狀", en: "Award certificate" }, url: "https://drive.google.com/file/d/1oM42ZAnmIG-xL0erraSG16VOwJG_Y5sN/view" }] }
      ]
    },
    {
      ...
      items: [
        ...
        { date: "2021", title: { zh: "IRB 人體研究倫理講習（8 學分）", en: "IRB Human Research Ethics Training (8 credits)" }, organization: { zh: "馬偕醫學院", en: "Mackay Medical College" }, type: { zh: "研究倫理", en: "Research ethics" }, evidence: [{ label: { zh: "結業證書", en: "Completion certificate" }, url: "https://drive.google.com/file/d/1NHPFM01put_n4nwQV6_J0gWu3K48963e/view" }] },
        { date: "2021", title: { zh: "學術倫理教育課程（6 小時）", en: "Academic Research Ethics Education (6 hours)" }, organization: { zh: "臺灣學術倫理教育資源中心", en: "Center for Taiwan Academic Research Ethics Education" }, type: { zh: "研究倫理", en: "Research ethics" }, evidence: [{ label: { zh: "修課證明", en: "Course certificate" }, url: "https://drive.google.com/file/d/1l_kfXXQyTSeiWWm7vXITJU5tpvrG_zdr/view" }] },
