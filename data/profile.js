window.PROFILE_DATA = {
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        { date: "2021", title: { zh: "高齡福祉科技研討會論文發表佳作獎", en: "Merit Award, Conference Paper Presentation" }, organization: { zh: "高齡福祉科技研討會", en: "Conference on Gerontechnology and Welfare Technology" }, type: { zh: "獎項", en: "Award" }, evidence: [{ label: { zh: "獲獎紀錄 PDF", en: "Award record PDF" }, url: "https://drive.google.com/file/d/1rtT_UCY8LEaty1QtDqdfQuidNAJ-z_JI/view" }] },
        { date: "2021", title: { zh: "研究生壁報競賽佳作獎", en: "Merit Award, Graduate Student Poster Competition" }, organization: { zh: "馬偕醫學院", en: "Mackay Medical College" }, type: { zh: "獎項", en: "Award" }, evidence: [{ label: { zh: "獲獎紀錄 PDF", en: "Award record PDF" }, url: "https://drive.google.com/file/d/1-eZ6YdQeuPAwnHSQ2ZnXm1MFPVng45vL/view" }] },
