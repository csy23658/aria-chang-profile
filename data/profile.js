...
const reviewEvidence = () => [{ label: { zh: "審查資料彙整", en: "Review-material summary" }, url: REVIEW_DOC }];
...
window.PROFILE_DATA = {
  sections: [
    ...
    },
    {
      ...
      ].map(item => ({ ...item, evidence: reviewEvidence() }))
    },
    {
